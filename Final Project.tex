...
In Section 2.1 we showed that no deterministic algorithm can have a competitive ratio of better than 1/2 in the unweighted case. It turns out that this is the best competitive ratio that can be achieved by any deterministic algorithm in the weighted case as well.
...
The proof of the approximation ratio of \textsc{Perturbed-Greedy} is quite similar to the proof of the approximation ratio of \textsc{Ranking} in Section~\ref{section:ranking}. We encourage readers to read this proof, as well as the proof of the optimality of the approximation ratio, in \cite{key-3}.
